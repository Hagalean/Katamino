...
public class Board {
    ...
    public void getBoardInfo() throws IOException{
        ...
        int index = 0;
        FileReader input = new FileReader("boards"+ "/"+textDir+"/"+textDir+".txt");
        ...
        index = 0;
        FileReader input2 = new FileReader("boards" + "/" + textDir + "/" + textDir + "blocks.txt");
        ...
        FileReader input3 = new FileReader("boards" + "/" + textDir + "/" + textDir + "Info.txt");
